...
class EighthTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let newItem = Item()
        newItem.title = "Проверить уровень масла, антифриза, тормозной жидкости и омывающей, - требуйте долива, если уровень меньше нормы"
        names.append(newItem)
        
        let newItem2 = Item()
        newItem2.title = "При помощи фонарика осмотреть двигатель на отсутствие подтеков масла, запотеваний"
        names.append(newItem2)
        
        let newItem3 = Item()
        newItem3.title = "Снять верхнюю крышку (кожух) двигателя и убедиться в отстутствии подтеков масла и наличия посторонних предметов"
